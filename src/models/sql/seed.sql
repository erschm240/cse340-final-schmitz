...
INSERT INTO roles (role_name, role_description) VALUES
    ...
    ('admin', 'Administrator with full system access (full CRUD privileges
    ), make changes to website and to tutorials, view and respond to all messages, may also react to tutorials but unlikely');
